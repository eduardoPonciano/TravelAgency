...
import br.com.eponciano.ms.booking.mvc.mapper.ProcesssBookingMapper;
import br.com.eponciano.ms.booking.mvc.model.dto.BookingDTO;
import br.com.eponciano.ms.booking.mvc.model.dto.PaymentCardDTO;
...
public class BookingController {
    ...
    public String showPaymentPage(Model model, RedirectAttributes redirectAttributes, HttpSession session) {
        ...
        HotelDTO hotelDTO = hotelService.findByParameters(bookingInitiationDTO.getHotelId(),null,null);
